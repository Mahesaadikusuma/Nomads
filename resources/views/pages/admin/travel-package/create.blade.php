            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('travel-package.index') }}">Paket Travel</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Tambah Paket Travel</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                        ...
                                        <div class="col-12 my-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="featured_event"
                                                    ...
                                                    name="featured_event" value="{{ old('featured_event') }}"
                                                    placeholder="" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12 my-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="language"
                                                    ...
                                                    name="language" value="{{ old('language') }}" placeholder="" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12 my-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="duration"
                                                    ...
                                                    name="duration" value="{{ old('duration') }}" placeholder="" />
                                            </div>
                                        </div>
